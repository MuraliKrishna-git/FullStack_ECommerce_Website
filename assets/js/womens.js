...
function showShirt(prod) {
    let skillsContainer3 = document.getElementById("sarees");
    let skillHTML3 = "";
    // const index = [6, 17, 18, 40];

    prod.forEach((b) => {
        if(b.type == "saree"){skillHTML3 += `
...
function showPant(prod) {
    let skillsContainer4 = document.getElementById("leggins");
    let skillHTML4 = "";
    // const index = [6, 17, 18, 40];

    prod.forEach((b) => {
        if(b.type == "leggins"){skillHTML4 += `
            <div class="bar" data-name="${b.name}" data-icon="${b.icon}" data-cost="${b.cost}" data-discount="${b.discount}">
                <div class="info" style="max-height: 500px;">
                    <img src="${b.icon}" class="card-img-top" alt="${b.name}">
                    <div class="btn-top">
...
function showDhoti(prod) {
    let skillsContainer5 = document.getElementById("inners-w");
    let skillHTML5 = "";
    // const index = [6, 17, 18, 40];

    prod.forEach((b) => {
        if(b.type == "inners-w"){skillHTML5 += `
            <div class="bar" data-name="${b.name}" data-icon="${b.icon}" data-cost="${b.cost}" data-discount="${b.discount}">
                <div class="info" style="max-height: 500px;">
                    <img src="${b.icon}" class="card-img-top" alt="${b.name}">
                    <div class="btn-top">
